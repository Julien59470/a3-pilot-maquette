const CACHE_NAME = 'a3-pilot-maquette-v4.9';
const APP_SHELL = [
  './', './index.html', './styles.css', './css/onboarding.css', './css/rbac.css', './css/terrain-preview.css', './app.js', './onboarding.js', './rbac.js', './terrain-preview.js', './manifest.webmanifest', './assets/icon.svg',
